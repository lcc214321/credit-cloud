...
public class TTenant extends TableImpl<TTenantRecord> {
    ...
    private static final long serialVersionUID = -146929518;
     ...
     */
    public final TableField<TTenantRecord, Integer> TYPE = createField("type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "租户类型：0-个人，1-公司");

    /**
     * The column <code>credit_cloud_console.t_tenant.status</code>. 租户状态：0-正常，9-删除
     */
    public final TableField<TTenantRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "租户状态：0-正常，9-删除");

    /**
     * The column <code>credit_cloud_console.t_tenant.created_at</code>. 创建时间
     */
    public final TableField<TTenantRecord, Timestamp> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>credit_cloud_console.t_tenant.update_at</code>. 更新时间
     */
    public final TableField<TTenantRecord, Timestamp> UPDATE_AT = createField("update_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
