...
public class TApplicationKey extends TableImpl<TApplicationKeyRecord> {
    ...
    private static final long serialVersionUID = 1719091589;
     ...
     */
    public final TableField<TApplicationKeyRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "Key的状态：0-正常，9-删除");

    /**
     * The column <code>credit_cloud_console.t_application_key.create_at</code>.
     */
    public final TableField<TApplicationKeyRecord, Timestamp> CREATE_AT = createField("create_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>credit_cloud_console.t_application_key.update_at</code>.
     */
    public final TableField<TApplicationKeyRecord, Timestamp> UPDATE_AT = createField("update_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
