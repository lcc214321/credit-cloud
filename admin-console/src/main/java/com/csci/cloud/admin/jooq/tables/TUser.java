...
public class TUser extends TableImpl<TUserRecord> {
    ...
    private static final long serialVersionUID = -1292178106;
     ...
     */
    public final TableField<TUserRecord, Integer> EMAIL_VERIFIED = createField("email_verified", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "邮箱是否验证：0-未验证，1-已验证");

    /**
     * The column <code>credit_cloud_console.t_user.mobile_verified</code>.
     */
    public final TableField<TUserRecord, Integer> MOBILE_VERIFIED = createField("mobile_verified", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>credit_cloud_console.t_user.status</code>. 用户状态：0-未激活，1-已激活，9-删除
     */
    public final TableField<TUserRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "用户状态：0-未激活，1-已激活，9-删除");
     ...
     */
    public final TableField<TUserRecord, Timestamp> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>credit_cloud_console.t_user.updated_at</code>. 更新时间
     */
    public final TableField<TUserRecord, Timestamp> UPDATED_AT = createField("updated_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
