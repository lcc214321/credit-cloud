...
import static com.csci.cloud.admin.captcha.config.CommonConfig.defaultHttpMessageConverters;

import com.csci.cloud.admin.captcha.CaptchaFallBackFactory;
import feign.Logger;
...
public class CaptchaConfig {
  ...
  public ErrorDecoder errorDecoder() {
    return new CaptchaErrorDecoder();
  }
  ...
  public FallbackFactory fallbackFactory() {
    return new CaptchaFallBackFactory();
  }
